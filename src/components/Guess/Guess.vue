<template>
    <view class="guess-wrap">
        ...
        <view class="guess">
            <navigator class="navigator" v-for="item in homeGoodsGuessLike" :key="item.id"
        ...
        <!-- 没有更多数据了 -->
        <view class="loading" v-if="homeGoodsGuessLikeTotal !== homeGoodsGuessLike.length">正在加载...</view>
    </view>
</template>
